...
public enum LangList {
    ...
    Japanese, Javanese,
    Kannada, Kazakh, Khmer, Kinyarwanda, Konkani, Korean, Krio, Kurdish, Kyrgyz,
    Lao, Latin, Latvian, Lingala, Lithuanian, Luganda, Luxembourgish,
    Macedonian, Maithili, Malagasy, Malay, Malayalam, Maltese, Maori, Marathi, Meiteilon, Mizo, Mongolian, Myanmar,
    Nepali, Norwegian,
    Odia, Oromo,
    Pashto, Persian, Polish, Portuguese, Punjabi,
    Quechua,
    Romanian, Russian,
    Samoan, Sanskrit, Scots, Sepedi, Serbian, Sesotho, Shona, Sindhi, Sinhala, Slovak, Slovenian, Somali, Spanish,
